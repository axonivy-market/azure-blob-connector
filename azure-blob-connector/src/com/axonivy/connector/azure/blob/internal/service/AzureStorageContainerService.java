...
public class AzureStorageContainerService extends AbstractAzureStorage {
	...
	public AzureStorageContainerService(Credential credential, String endpoint, String container) {
		this.endpoint = endpoint;
		this.container = container;

		containerPath = String.format("%s/{container}", endpoint);
	...
	public boolean createContainerIfNotExists(String container) {
		...
		try {
			var response = this.httpClient.put(containerPath, emptyMap(), queries, this.container);
	...
	private boolean isExists(String container) {
		...
		try {
			var response = this.httpClient.get(containerPath, queries, this.container);
